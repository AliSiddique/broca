          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-white focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <span className="flex select-none items-center pl-3 text-white sm:text-sm">workcation.com/</span>
                  <input
                    type="text"
                    name="username"
                    id="username"
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  name="about"
                  rows={3}
                  className="block w-full rounded-md border-0 text-white shadow-sm ring-1 ring-inset ring-white placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"
                  defaultValue={''}
                />
              </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="rounded-md bg-white py-1.5 px-2.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-white hover:bg-gray-50"
                >
                  Change
                </button>
              </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                >
