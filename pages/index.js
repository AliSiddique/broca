...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link href={`/api/auth/login`} className="text-sm font-semibold leading-6 text-white">
      ...
      <main className="isolate bg-gradient-to-r from-gray-700 via-gray-900 to-black">
        {/* Hero section */}
          ...
          <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#6FBBFF" />
                  <stop offset={1} stopColor="#2599FF" />
                  <stop offset={3} stopColor="#2599FF" />
                  <stop  stopColor="#2599FF" />
                  <stop  stopColor="#2599FF" />
                  <stop offset={7} stopColor="#2599FF" />
                  <stop offset={8} stopColor="#2599FF" />

                </linearGradient>
              </defs>
            </svg>
          </div>
          <div className="absolute inset-x-0 top-100 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
            <svg
              className="relative left-[calc(10%-1rem)] -z-10 h-[1.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[42.375rem]"
              viewBox="0 0 1155 678"
            >
              <path
                fill="url(#9b2541ea-d39d-499b-bd42-aeea3e93f5ff)"
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  Write code and debug with confidence
                </h1>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <Link
                    href={`/api/auth/login`}
                    className="rounded-md border-2 border-white bg-clip-border px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Get started
                  </Link>
              ...
              {tiers.map((tier, tierIdx) => (
                <div
                  ...
                  className={classNames(
                    ...
                    'flex flex-col justify-between rounded-3xl bg-gradient-to-r from-gray-700 via-gray-900 to-black p-8 ring-1 ring-gray-200 xl:p-10'
                  )}
                >
                  <div>
