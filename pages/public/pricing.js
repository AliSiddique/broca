    ...
    <div className="bg-gradient-to-r from-gray-700 via-gray-900 to-black">
      ...
      <main>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
          ...
          <div className=" mx-auto mt-10 grid max-w-xl align-center grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-7xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
            {pricing.tiers.map((tier) => (
              ...
              >
                ...
                <p className="mt-6 flex items-baseline gap-x-1">
                  ...
                  <span className="text-sm font-semibold leading-6 text-white">{frequency.priceSuffix}</span>
                </p>
                <a
                  href={tier.href}
        ...
        <div className="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full bg-gray-50 px-4 py-1.5 text-sm leading-6 text-white ring-1 ring-inset ring-gray-900/5">
